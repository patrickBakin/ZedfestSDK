...
struct ARocketProjectileBase_C_BndEvt__ProjectileMovement_K2Node_ComponentBoundEvent_1_OnProjectileStopDelegate__DelegateSignature_Params
{
	struct FHitResult*                                 ImpactResult;                                             // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function RocketProjectileBase.RocketProjectileBase_C.ExecuteUbergraph_RocketProjectileBase
struct ARocketProjectileBase_C_ExecuteUbergraph_RocketProjectileBase_Params
{
