...
struct AWeaponProjectileBase_C_BndEvt__ProjectileMovement_K2Node_ComponentBoundEvent_0_OnProjectileStopDelegate__DelegateSignature_Params
{
	struct FHitResult*                                 ImpactResult;                                             // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function WeaponProjectileBase.WeaponProjectileBase_C.ExecuteUbergraph_WeaponProjectileBase
struct AWeaponProjectileBase_C_ExecuteUbergraph_WeaponProjectileBase_Params
{
