...
public:
	...
	struct FScriptMulticastDelegate                    FadeOutFinished;                                          // 0x0240(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass FadeOut.FadeOut_C");
		return ptr;
	}
	...
	void Construct();
	void OnAnimFinish();
	void ExecuteUbergraph_FadeOut(int* EntryPoint);
