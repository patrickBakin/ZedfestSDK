...
struct UBTS_MatchSpeed_C_ReceiveActivation_Params
{
	class AActor**                                     OwnerActor;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BTS_MatchSpeed.BTS_MatchSpeed_C.ReceiveTick
struct UBTS_MatchSpeed_C_ReceiveTick_Params
{
	class AActor**                                     OwnerActor;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
struct UBTS_MatchSpeed_C_ExecuteUbergraph_BTS_MatchSpeed_Params
{
