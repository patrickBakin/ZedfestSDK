...
// BlueprintGeneratedClass BPA_Parent_SphereTrace.BPA_Parent_SphereTrace_C
// 0x003C (0x036C - 0x0330)
class ABPA_Parent_SphereTrace_C : public AActor
{
public:
	...
	float                                              SphereTraceRadius;                                        // 0x0368(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BPA_Parent_SphereTrace.BPA_Parent_SphereTrace_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BPA_Parent_SphereTrace(int* EntryPoint);
};
