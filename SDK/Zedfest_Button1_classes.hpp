...
// WidgetBlueprintGeneratedClass Button1.Button1_C
// 0x0569 (0x0799 - 0x0230)
class UButton1_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Button1.Button1_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Button1(int* EntryPoint);
