...
struct ABP_Grenade_DeluxeBoss_Enraged_C_IsAllowedTarget_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function BP_Grenade_DeluxeBoss_Enraged.BP_Grenade_DeluxeBoss_Enraged_C.ReceiveBeginPlay
struct ABP_Grenade_DeluxeBoss_Enraged_C_ReceiveBeginPlay_Params
{
};

// Function BP_Grenade_DeluxeBoss_Enraged.BP_Grenade_DeluxeBoss_Enraged_C.ExecuteUbergraph_BP_Grenade_DeluxeBoss_Enraged
struct ABP_Grenade_DeluxeBoss_Enraged_C_ExecuteUbergraph_BP_Grenade_DeluxeBoss_Enraged_Params
{
