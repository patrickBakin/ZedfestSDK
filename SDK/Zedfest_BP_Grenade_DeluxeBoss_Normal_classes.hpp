...
// BlueprintGeneratedClass BP_Grenade_DeluxeBoss_Normal.BP_Grenade_DeluxeBoss_Normal_C
// 0x0023 (0x0408 - 0x03E5)
class ABP_Grenade_DeluxeBoss_Normal_C : public ABP_Grenade_Parent_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Grenade_DeluxeBoss_Normal.BP_Grenade_DeluxeBoss_Normal_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Grenade_DeluxeBoss_Normal(int* EntryPoint);
};
