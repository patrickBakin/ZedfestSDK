...
// WidgetBlueprintGeneratedClass StoreSpecialItemCard.StoreSpecialItemCard_C
// 0x0148 (0x0378 - 0x0230)
class UStoreSpecialItemCard_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass StoreSpecialItemCard.StoreSpecialItemCard_C");
		return ptr;
	}
