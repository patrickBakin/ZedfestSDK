...
struct ABP_PR_Objective_EndCollision_C_BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params
{
...
struct ABP_PR_Objective_EndCollision_C_BndEvt__Box_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature_Params
{
	class UPrimitiveComponent**                        OverlappedComponent;                                      // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AActor**                                     OtherActor;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	class UPrimitiveComponent**                        OtherComp;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
...
struct ABP_PR_Objective_EndCollision_C_ComputerConsoleEvent_Params
{
...
struct ABP_PR_Objective_EndCollision_C_ReceiveBeginPlay_Params
{
};

// Function BP_PR_Objective_EndCollision.BP_PR_Objective_EndCollision_C.ComputerConsoleVfx
struct ABP_PR_Objective_EndCollision_C_ComputerConsoleVfx_Params
{
};

// Function BP_PR_Objective_EndCollision.BP_PR_Objective_EndCollision_C.ExecuteUbergraph_BP_PR_Objective_EndCollision
struct ABP_PR_Objective_EndCollision_C_ExecuteUbergraph_BP_PR_Objective_EndCollision_Params
{
