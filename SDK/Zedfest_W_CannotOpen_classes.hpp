...
// WidgetBlueprintGeneratedClass W_CannotOpen.W_CannotOpen_C
// 0x0030 (0x0260 - 0x0230)
class UW_CannotOpen_C : public UUserWidget
{
public:
	...
	struct FText                                       Textie;                                                   // 0x0248(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass W_CannotOpen.W_CannotOpen_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_W_CannotOpen(int* EntryPoint);
};
