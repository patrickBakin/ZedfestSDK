...
void APickupBase_C::OnRep_ItemClass()
{
	static auto fn = UObject::FindObject<UFunction>("Function PickupBase.PickupBase_C.OnRep_ItemClass");

	APickupBase_C_OnRep_ItemClass_Params params;
...
void APickupBase_C::SetRarityColorEvent()
{
	static auto fn = UObject::FindObject<UFunction>("Function PickupBase.PickupBase_C.SetRarityColorEvent");

	APickupBase_C_SetRarityColorEvent_Params params;
