...
// WidgetBlueprintGeneratedClass Seperator.Seperator_C
// 0x0008 (0x0238 - 0x0230)
class USeperator_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Seperator.Seperator_C");
		return ptr;
	}
