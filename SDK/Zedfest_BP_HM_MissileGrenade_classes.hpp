...
// BlueprintGeneratedClass BP_HM_MissileGrenade.BP_HM_MissileGrenade_C
// 0x0023 (0x0408 - 0x03E5)
class ABP_HM_MissileGrenade_C : public ABP_Grenade_Parent_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_HM_MissileGrenade.BP_HM_MissileGrenade_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_HM_MissileGrenade(int* EntryPoint);
};
