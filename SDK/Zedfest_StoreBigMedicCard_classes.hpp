...
// WidgetBlueprintGeneratedClass StoreBigMedicCard.StoreBigMedicCard_C
// 0x0148 (0x0378 - 0x0230)
class UStoreBigMedicCard_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass StoreBigMedicCard.StoreBigMedicCard_C");
		return ptr;
	}
	...
	struct FText GetConsumableAmountSlot6();
	struct FText Get_WeaponCost_Text_1();
	void OnFailure_F5C679D44C5B5D4AC89F3D81F028C906();
	void OnSuccess_F5C679D44C5B5D4AC89F3D81F028C906();
	void OnFailure_882149E04EA7E5DA83397798862602BB(struct FName* WrittenAchievementName, float* WrittenProgress, int* WrittenUserTag);
	void OnSuccess_882149E04EA7E5DA83397798862602BB(struct FName* WrittenAchievementName, float* WrittenProgress, int* WrittenUserTag);
	...
	void UpdateStoreBigMedicCard();
	void ExecuteUbergraph_StoreBigMedicCard(int* EntryPoint);
