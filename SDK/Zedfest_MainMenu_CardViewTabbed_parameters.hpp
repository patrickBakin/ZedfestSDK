...
struct UMainMenu_CardViewTabbed_C_OnKeyDown_Params
{
...
struct UMainMenu_CardViewTabbed_C_OnPreviewKeyDown_Params
{
	struct FGeometry*                                  MyGeometry;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData)
	struct FKeyEvent*                                  InKeyEvent;                                               // (BlueprintVisible, BlueprintReadOnly, Parm)
	struct FEventReply                                 ReturnValue;                                              // (Parm, OutParm, ReturnParm)
...
struct UMainMenu_CardViewTabbed_C_OnFocusLost_Params
{
	struct FFocusEvent*                                InFocusEvent;                                             // (BlueprintVisible, BlueprintReadOnly, Parm)
};

// Function MainMenu_CardViewTabbed.MainMenu_CardViewTabbed_C.ReFocus
struct UMainMenu_CardViewTabbed_C_ReFocus_Params
{
};

// Function MainMenu_CardViewTabbed.MainMenu_CardViewTabbed_C.OnTabChange
struct UMainMenu_CardViewTabbed_C_OnTabChange_Params
{
...
struct UMainMenu_CardViewTabbed_C_CustomEvent_3_Params
{
...
struct UMainMenu_CardViewTabbed_C_BndEvt__WeeklyObjectiveButton_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature_Params
{
};

// Function MainMenu_CardViewTabbed.MainMenu_CardViewTabbed_C.cancelExit
struct UMainMenu_CardViewTabbed_C_cancelExit_Params
{
};

// Function MainMenu_CardViewTabbed.MainMenu_CardViewTabbed_C.EventMenuUpdateWeeklyButton
struct UMainMenu_CardViewTabbed_C_EventMenuUpdateWeeklyButton_Params
{
...
struct UMainMenu_CardViewTabbed_C_MainMenuTabClicked_Params
{
...
struct UMainMenu_CardViewTabbed_C_BndEvt__ChallengesButton_K2Node_ComponentBoundEvent_2_OnClicked__DelegateSignature_Params
{
};
...
struct UMainMenu_CardViewTabbed_C_BndEvt__Button_46_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function MainMenu_CardViewTabbed.MainMenu_CardViewTabbed_C.ExecuteUbergraph_MainMenu_CardViewTabbed
struct UMainMenu_CardViewTabbed_C_ExecuteUbergraph_MainMenu_CardViewTabbed_Params
{
