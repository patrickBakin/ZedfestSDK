...
// BlueprintGeneratedClass BP_FullInteractWidgetAddOn.BP_FullInteractWidgetAddOn_C
// 0x0031 (0x0361 - 0x0330)
class ABP_FullInteractWidgetAddOn_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_FullInteractWidgetAddOn.BP_FullInteractWidgetAddOn_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_FullInteractWidgetAddOn(int* EntryPoint);
};
