...
// BlueprintGeneratedClass BP_ConveyorBeltButton.BP_ConveyorBeltButton_C
// 0x00D8 (0x0408 - 0x0330)
class ABP_ConveyorBeltButton_C : public AActor
{
public:
	...
	float                                              AnimTimeline_Animation_26D1B71E41F6122B9EF13BAE986A5C63;  // 0x0358(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    AnimTimeline__Direction_26D1B71E41F6122B9EF13BAE986A5C63; // 0x035C(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_ConveyorBeltButton.BP_ConveyorBeltButton_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_ConveyorBeltButton(int* EntryPoint);
};
