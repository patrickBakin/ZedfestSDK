...
// WidgetBlueprintGeneratedClass MapButtonLobby.MapButtonLobby_C
// 0x05A8 (0x07D8 - 0x0230)
class UMapButtonLobby_C : public UUserWidget
{
public:
	...
	class UWBP_Lobby_Main_C*                           LobbyRef;                                                 // 0x07A8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass MapButtonLobby.MapButtonLobby_C");
		return ptr;
	}
	...
	void SetFocus();
	void RemoveFocus();
	void ExecuteUbergraph_MapButtonLobby(int* EntryPoint);
