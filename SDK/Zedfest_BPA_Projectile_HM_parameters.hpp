...
struct ABPA_Projectile_HM_C_IsAllowedTarget_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function BPA_Projectile_HM.BPA_Projectile_HM_C.ReceiveHit
struct ABPA_Projectile_HM_C_ReceiveHit_Params
{
...
struct ABPA_Projectile_HM_C_ReceiveBeginPlay_Params
{
};

// Function BPA_Projectile_HM.BPA_Projectile_HM_C.ExecuteUbergraph_BPA_Projectile_HM
struct ABPA_Projectile_HM_C_ExecuteUbergraph_BPA_Projectile_HM_Params
{
