...
public:
	...
	bool                                               CanPlayerBeDamaged_;                                      // 0x0A60(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	bool                                               SentryTrap_;                                              // 0x0A89(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData24[0x6];                                       // 0x0A8A(0x0006) MISSED OFFSET
	TArray<class ABP_SpecialItem_Parent_C*>            TrapReference;                                            // 0x0A90(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance)
	int                                                TrapArrayNumber;                                          // 0x0AA0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void ProperlyDestroyedTrapEvent(class AItemBase_C** TrapRef, int* TrapNumber);
	void TrapBoxInfoTextEvent(bool* DestroyFirstOne_);
