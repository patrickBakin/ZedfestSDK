...
// WidgetBlueprintGeneratedClass WeeklyButton.WeeklyButton_C
// 0x0588 (0x07B8 - 0x0230)
class UWeeklyButton_C : public UUserWidget
{
public:
	...
	struct FText                                       ButtonLabel;                                              // 0x0278(0x0018) (Edit, BlueprintVisible)
	struct FKey                                        KeyboardShortcut;                                         // 0x0290(0x0018) (Edit, BlueprintVisible)
	...
	struct FLabelStyle                                 LabelStyle;                                               // 0x02D8(0x0030) (Edit, BlueprintVisible, IsPlainOldData)
	struct FMargin                                     LabelPadding;                                             // 0x0308(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FButtonStyle                                ButtonStyle;                                              // 0x0318(0x0278) (Edit, BlueprintVisible)
	struct FSlateFontInfo                              LabelFont;                                                // 0x0590(0x0050) (Edit, BlueprintVisible)
	...
	struct FButtonAudio                                Sound;                                                    // 0x05E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FSlateBrush                                 HoverFX;                                                  // 0x05F8(0x0088) (Edit, BlueprintVisible)
	struct FMargin                                     FXPadding;                                                // 0x0680(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FMargin                                     ButtonMargin;                                             // 0x0690(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FNavItemActionStruct                        Navigation_Action;                                        // 0x06A8(0x0058) (Edit, BlueprintVisible, ZeroConstructor)
	...
	struct FSlateBrush                                 KbShortcutBackground;                                     // 0x0710(0x0088) (Edit, BlueprintVisible)
	bool                                               CanBeSelected;                                            // 0x0798(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0799(0x0003) MISSED OFFSET
	int                                                MonthIndex;                                               // 0x079C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FText>                               MonthArray;                                               // 0x07A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	class UClass*                                      SeasonWidget;                                             // 0x07B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WeeklyButton.WeeklyButton_C");
		return ptr;
	}
	...
	void RemoveFocus();
	void Construct();
	void ExecuteUbergraph_WeeklyButton(int* EntryPoint);
