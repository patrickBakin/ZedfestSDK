...
// WidgetBlueprintGeneratedClass MeleeWeaponCard.MeleeWeaponCard_C
// 0x01A6 (0x03D6 - 0x0230)
class UMeleeWeaponCard_C : public UUserWidget
{
public:
	...
	TArray<class UClass*>                              MeleeWeaponUpgrades;                                      // 0x03C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                WeaponLvlInt;                                             // 0x03D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IngameUnlockable_;                                        // 0x03D4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
<<<<<<< HEAD
	bool                                               ¡_C;                                                      // 0x03D5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
=======
	bool                                               _C;                                                      // 0x03D5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
>>>>>>> 797536caccfe399b6e4d522f8bf7978365d4b985
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass MeleeWeaponCard.MeleeWeaponCard_C");
		return ptr;
	}
	...
	void CustomEvent_3();
	void CustomEvent_2();
	void ExecuteUbergraph_MeleeWeaponCard(int* EntryPoint);
