...
// WidgetBlueprintGeneratedClass SettingCards.SettingCards_C
// 0x00F0 (0x0320 - 0x0230)
class USettingCards_C : public UUserWidget
{
public:
	...
	class UTextBlock*                                  line_2_text;                                              // 0x0250(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SettingCards.SettingCards_C");
		return ptr;
	}
	...
	void RemoveFocus();
	void OnClick();
	void ExecuteUbergraph_SettingCards(int* EntryPoint);
