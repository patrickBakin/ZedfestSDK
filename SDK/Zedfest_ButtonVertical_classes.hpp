...
// WidgetBlueprintGeneratedClass ButtonVertical.ButtonVertical_C
// 0x0569 (0x0799 - 0x0230)
class UButtonVertical_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ButtonVertical.ButtonVertical_C");
		return ptr;
	}
	...
	void VerticalText(struct FString* Text, struct FString* LocalString1);
	...
	void SetFocus();
	void RemoveFocus();
	void ExecuteUbergraph_ButtonVertical(int* EntryPoint);
