...
void ABP_Security_Camera_Tracking_C::OnRep_CameraShot_()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Security_Camera_Tracking.BP_Security_Camera_Tracking_C.OnRep_CameraShot?");

	ABP_Security_Camera_Tracking_C_OnRep_CameraShot__Params params;
...
void ABP_Security_Camera_Tracking_C::DisableCameraRepEvent()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Security_Camera_Tracking.BP_Security_Camera_Tracking_C.DisableCameraRepEvent");

	ABP_Security_Camera_Tracking_C_DisableCameraRepEvent_Params params;
