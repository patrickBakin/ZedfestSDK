...
// BlueprintGeneratedClass BP_Base_AI_SpawnExpand.BP_Base_AI_SpawnExpand_C
// 0x0021 (0x0351 - 0x0330)
class ABP_Base_AI_SpawnExpand_C : public AActor
{
public:
	...
	bool                                               PlayerInSphere_;                                          // 0x0350(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_AI_SpawnExpand.BP_Base_AI_SpawnExpand_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Base_AI_SpawnExpand(int* EntryPoint);
};
